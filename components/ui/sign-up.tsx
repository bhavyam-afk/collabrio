...
import { AlertCircle, ArrowLeft, ArrowRight, Eye, EyeOff, Gem, Loader, Lock, Mail, PartyPopper, X } from "lucide-react"; 
// Importing animation components from framer-motion
import { AnimatePresence, Transition, Variants, motion, useInView } from "framer-motion";
import type { GlobalOptions as ConfettiGlobalOptions, CreateTypes as ConfettiInstance, Options as ConfettiOptions } from "canvas-confetti"
import React, { Children, createContext, forwardRef, useCallback, useEffect, useImperativeHandle, useMemo, useRef, useState } from "react";
...
useEffect(() => {
  ...
  return (
    <div className="bg-background h-[70vh] w-[80vw] flex flex-col fixed overflow-hidden rounded-2xl">
        <style>{`
